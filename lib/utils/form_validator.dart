...
class FormValidator {
  ...
  final String _invalidEmailError =
      'يرجى إدخال عنوان بريد إلكتروني صالح'; // 'Please enter a valid email address'
  final String _invalidPhoneError =
      'يرجي إدخال رقم هاتف صالح باللغة الإنجليزية'; // 'Please enter a valid phone number'

  /// The error message for empty email input.
  final String _emptyEmailInputError = 'Please enter an email';
  final String _emptyPhoneInputError =
      "من فضلك ادخل رقم هاتفك"; // 'Please enter an phone'
  final String _emptyEmailOrPhoneInputError =
      'من فضلك ادخل رقم هاتفك أو الإيميل'; // 'Please Enter an Email or Phone'
  final String _invalidEmailOrPhoneInputError =
      'الرجاء إدخال بريد إلكتروني صالح أو هاتف صالح ( باللغة الإنجليزية )'; // 'Please enter an valid Email or Phone'

  /// The error message for empty password input.
  final String _emptyPasswordInputError =
      'من فضلك ادخل الباسورد'; // lease enter a password'

  /// The error message for invalid confirm password input.
  final String _invalidConfirmPwError =
      "كلمات المرور غير متطابقة"; // "Passwords don't match"

  /// The error message for invalid current password input.
  final String _invalidCurrentPwError =
      'كلمة مرور غير صحيحة'; // 'Invalid current password!'
  ...
  final String _invalidNameError =
      'رجاء ادخل اسما صحيحا'; // 'Please enter a valid Name '
  final String _invalidAnyTextForm =
